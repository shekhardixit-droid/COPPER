...
const MeetCopper = () => {
  ...
  return (
    <div className="w-full bg-white">
      <Helmet>
  <title>Meet Copper | Copper Studio</title>
  <meta
    name="description"
    content="Meet Copper Studio and discover our approach to creating thoughtful digital brands and experiences."
  />
  <meta
  property="og:image"
...
<meta property="og:site_name" content="Copper Studio" />
      ...
      {/* CENTERED CONTENT WRAPPER: keeps everything centered at every zoom level */}

      <div className="mx-auto w-full max-w-[1280px] min-[768px]:max-[1279px]:px-5">
